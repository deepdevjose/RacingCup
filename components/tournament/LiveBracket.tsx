                        ...
                        <div className="bracket-container">
                            ...
                            <div className="bracket-side bracket-left">
                                <div className="bracket-round round-16">
                                    ...
                                    <div className="match-group">
                                        <MatchItem match={getMatch(8, 0)} />
                                        <MatchItem match={getMatch(8, 1)} />
                                    </div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(8, 2)} />
                                        <MatchItem match={getMatch(8, 3)} />
                                    </div>
                                </div>
                                ...
                                <div className="bracket-round round-8">
                                    ...
                                    <div className="match-group">
                                        <MatchItem match={getMatch(4, 0)} />
                                    </div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(4, 1)} />
                                    </div>
                                </div>
                            ...
                            <div className="bracket-side bracket-right">
                                ...
                                <div className="bracket-round round-8">
                                    <div className="round-label">Cuartos</div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(4, 2)} />
                                    </div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(4, 3)} />
                                    </div>
                                </div>
                                ...
                                <div className="bracket-round round-16">
                                    <div className="round-label">Octavos</div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(8, 4)} />
                                        <MatchItem match={getMatch(8, 5)} />
                                    </div>
                                    <div className="match-group">
                                        <MatchItem match={getMatch(8, 6)} />
                                        <MatchItem match={getMatch(8, 7)} />
                                    </div>
                                </div>
                            </div>
                        </div>
